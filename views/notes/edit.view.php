    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
      <div class="mt-5 md:col-span-2 md:mt-0">
        <form method="POST" action="/note">
          ...
          <!-- custom request patch, because browswers do not support patch -->
          ...
          <div class="shadow sm:overflow-hidden sm:rounded-md">
            ...
            <div class=" flex gap-x-4 justify-end  bg-gray-50 px-4 py-3 text-right sm:px-6">

              <a href="/notes" class="inline-flex justify-center rounded-md border border-transparent bg-gray-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                Cancel
              </a>
